...
BrowserHistory = (function() {
    ...
    function hashChangeHandler()
    {
        ...
        if (typeof BrowserHistory_multiple != "undefined" && BrowserHistory_multiple == true) {
        	...
        	if (player)
        		player.browserURLChange(flexAppUrl);
        }
    }
    ...
    var _initialize = function () {
        ...
        if (browser.ie)
        {
            ...
            for (var i = 0, s; s = scripts[i]; i++) {
                if (s.src.indexOf("history.js") > -1 || s.src.indexOf("history.min.js") > -1) {
                    var iframe_location = (new String(s.src)).replace("history.min.js", "historyFrame.html");
                }
            }
            ...
            iframe.src = ctxPath + "/js/historyFrame.html";
        ...
        if (browser.safari && !browserHasHashChange)
        {
            ...
            for (var i = 0, s; s = scripts[i]; i++) {
                if (s.src.indexOf("history.js") > -1 || s.src.indexOf("history.min.js") > -1) {
                    html = (new String(s.src)).replace(".min.js", ".html");
                }
            }
    ...
    return {
        ...
        browserURLChange: function(flexAppUrl) {
            ...
            // 自定义代码
            $("body").viewNavigator("popView", true);
        },
