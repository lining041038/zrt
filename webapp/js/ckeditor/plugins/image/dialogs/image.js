...
(function() {
	var imageDialog = function( editor, dialogType ) {
			...
			return {
				...
				onOk: function() {
					if (!$(".cke_dialog_ui_labeled_label:contains(labeldyuanwenjian)").next().find("input").val()) {
						alert("请上传图片后再确定！");
						return false;
					};
					//return false;
				...
				contents: [
					{
						...
						elements: [
							...
							id: 'upload',
							requried:true,
							action: ctx + "/common/CKEditorUtilController/uploadImageFile.vot",
