...
$(function(){
	...
	$.getJSON(ctx + "/common/componentsv2/ListSelectController/getListSelectOptions.vot?component=" + comp, function(data){
		...
		$("#leftgrid").datagrid({
			dataProvider: ctx + "/common/componentsv2/ListSelectController/getListSelectItemsToSelect.vot?component=" + comp + "&queryval=" + encodeURIComponent(encodeURIComponent($("#queryval").val())) + "&" + formdata,
			columns: ncolumns,
			pagebuttonnum: 0,
		...
		if (selectedItemSids || parentsid) {
			<%if ("multipleRows".equals(request.getParameter("selectionMode"))) { %>
			$.post(ctx + "/common/componentsv2/ListSelectController/getHistSelectedItems.vot?component=" + comp, "selectedItemSids=" + selectedItemSids + "&parentsid=" + parentsid, function (data){
