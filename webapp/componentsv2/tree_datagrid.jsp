...
$(function(){
	$("#treecol").resize(function(){
		$(".autoheightnode").height($("#treecol").height()- 50);
	}).resize();
...
<div class="ui-layout-center" style="overflow-y:hidden;">
	<div class="ui-widget ui-widget-content" style="height: 100%; margin: 2px; ">
		<div class="ui-widget-header" style="height: 30px;">
			<span style="margin-top:8px;display:block; margin-left: 5px; font-size: 24px;font-weight: bold;"><%=i18n.get("tree_datagrid." + component + ".listtitle") %></span>
		...
		<div class="autoheightnode" style="overflow-x: hidden;overflow-y: auto; position: relative;">
			<jsp:include page="/componentsv2/supportjsps/singledatagrid_mainbodypart.jsp">
				<jsp:param name="querypartpos" value="right:67px;top:52px;"/>
			</jsp:include>
		</div>
	</div>
</div>
