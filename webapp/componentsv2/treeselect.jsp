...
$(function(){
	...
	$.getJSON(ctx + "/common/componentsv2/TreeSelectController/getTreeSelectOptions.vot?component=" + comp, function(data){
		...
		if (selectedItemSids || parentsid) {
			$.post(ctx + "/common/componentsv2/TreeSelectController/getHistSelectedItems.vot?component=" + comp, "selectedItemSids=" + selectedItemSids + "&parentsid=" + parentsid, function (data){
...
function createLeftGridTree() {
	zTree = $("#leftgrid").tree("destroy").tree({
		checkable:treecheckable,
		asyncUrl: ctx + "/common/componentsv2/TreeSelectController/getTreeSelectItemsToSelect.vot?component=" + comp + "&queryval=" + encodeURIComponent(encodeURIComponent($("#queryval").val())) + "&" + formdata + "&" + $.param(currtreefilters),
...
function leftListQuery() {
	...
	if (queryval) {
		$("#leftgrid").datagrid("option", "dataProvider", ctx + "/common/componentsv2/ListSelectController/getListSelectItemsToSelect.vot?component=" + comp + "&queryval=" + encodeURIComponent(encodeURIComponent($("#queryval").val())) + "&" + formdata);
	} else {
		$("#leftgrid").datagrid("option", "dataProvider", ctx + "/common/componentsv2/ListSelectController/getListSelectItemsToSelect.vot?component=" + comp + "&" + formdata);
	}
}
