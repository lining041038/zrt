...
$(function(){
	$("body").loadDataMap({
		readRegionOrgRelateUrl:ctxPath + "/common/getAllMapRelateInfos.vot",
	...
	//	province:"330000",
		...
		datasources:[{
			label:"天津天气预报",
			countDataProvider: "<%=request.getContextPath()%>/demos/countdataprovider.jsp",
			detailDataProvider: "<%=request.getContextPath()%>/demos/datamapdata.jsp"
		}], showDateRegion:true, openSmallRegion: true, showWorld:false,
