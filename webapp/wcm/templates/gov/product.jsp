	...
	<div class="wrap">
		<div class="frame-pane">
			...
			<div class="article-colum">
				<div class="pages-title"><%=webdata.getProductName() %></div>
				<div class="pages-date">
					<span class="font"><%=webdata.getHeaderInfo() %></span> <%=webdata.getProductCreatetime()==null?"":webdata.getProductCreatetime().toString().substring(0,19)%>
				...
				<div class="pages_content">
					<div class="right" id="right">
						<div style="text-align: center">
							<img id="showImg" src="<%=request.getContextPath()%>/upload/UploadController/getSingleImageDataByFilegroupsid.vot?filegroupsid=<%=webdata.getProductImgSid() %>" border="0">
							<script>
								(function(){
									if($("#showImg").width()>900){
										$("#showImg").width(900);
									}
								})();
							</script>
