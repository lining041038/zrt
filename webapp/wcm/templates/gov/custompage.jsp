	...
	<div class="wrap">
		<div class="frame-pane">
			...
			<div class="article-colum">
				<div class="pages-title"><%=webdata.getCustomTitle()==null?"":webdata.getCustomTitle() %></div>
					<%-- 
...
<div id="main">
	...
	<div class="content" style="background-color: #f9f9f9; background-image: url('<%=request.getContextPath() + webdata.getTemplatepath()%>/assets/jiaoyubg.jpg'); background-repeat:  repeat-y;">
    	...
    	<div class="right" id="right">
    		<div style="width: 770px; min-height:250px; background: white; padding-top: 39px; padding-bottom: 123px; padding-left: 28px; padding-right: 28px; line-height: 2em;">
    			<%=webdata.getCustomContent() %>
    		</div>
    	</div>
    	<div style="clear:left;"></div>
