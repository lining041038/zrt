...
$(function(){
	$("#metlist2").tilegrid({
		...
		tileRenderer: function(gridinfo) {
			return '<LI class="list"><SPAN>[' + this.createtime + ']</SPAN><A style="position:relative; left:-15px;" title="' + this.name + '" \
			href="article.jsp?sitesid=<%=webdata.getSitesid()%>&sid=' + this.sid + '&type=article&webpagepos=<%=request.getParameter("webpagepos")%>"\
