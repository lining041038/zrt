...
<form id="singlegridform_imp" style="display: none;" enctype="multipart/form-data">
	...
	<button onclick="downloadImpTemp__()" class="button" style="float: right;"><%=i18n.get("antelope.templatedownload") %></button>
</form>
<!-- 新建修改查看对话框内容 -->
<form id="singlegridform" <%=CreateUpdateWindowMode.DIALOG_TOP_IFRAME.equals(opts.createUpdateWindowMode)?" ":" style=\"display:none;\"" %> >
