...
function getDialogTopParams() {
	...
	params.dialogTopURL = ctx + "/components/supportjsps/singledatagrid_dialogtopiframe.jsp?component=<%=opts.getComponent()%>&ifrformname=<%=formname%>";
...
function rebuildqueryformdiv_(params) {
	$(".condition.basicinfo").load(ctx + "/components/supportjsps/grid_querypart.jsp" + (params||""));
}
