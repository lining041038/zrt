...
$(function(){
	...
	$( ".tabs" ).bind( "tabsselect", function(event, ui) {
		setTimeout(function(){
			...
			read($(ui.panel).find(".tbiner").attr("id"));
		}, 100);
	});
	<%
	int layouti = 0;
...
<body class="sm_main">
   	<div class="tabs">
		<ul id="tabul" style="float: left;">
			...
			<%if (TextUtils.stringSet(opts.selectedTabKey) && opts.selectedTabKey.equals(entry.getKey())) { %>selected="true"<%} %>
