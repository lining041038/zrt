...
@rem Set BEA Home
set BEA_HOME=D:\Oracle\Middleware1035
...
set MW_HOME=D:\Oracle\Middleware1035
FOR %%i IN ("%MW_HOME%") DO SET MW_HOME=%%~fsi
@rem Set WebLogic Home
set WL_HOME=D:\Oracle\Middleware1035\wlserver_10.3
FOR %%i IN ("%WL_HOME%") DO SET WL_HOME=%%~fsi
@rem Set Coherence Home
set COHERENCE_HOME=D:\Oracle\Middleware1035\coherence_3.6
FOR %%i IN ("%COHERENCE_HOME%") DO SET COHERENCE_HOME=%%~fsi
@rem Set Common Modules Directory
set MODULES_DIR=D:\Oracle\Middleware1035\modules
FOR %%i IN ("%MODULES_DIR%") DO SET MODULES_DIR=%%~fsi
@rem Set Common Features Directory
set FEATURES_DIR=D:\Oracle\Middleware1035\modules\features
...
@rem Reset JAVA Home
set  JAVA_HOME=D:\Oracle\Middleware1035\jrockit_160_24_D1.1.2-4
...
set JAVA_VM=-client
set MEM_ARGS=-Xms256m -Xmx1024m -XX:MaxPermSize=400m -XX:+UseSpinning
set JAVA_OPTIONS=%JAVA_OPTIONS% -Xverify:none
goto continue
:sun_prod_mode
set JAVA_VM=-server
...
set FMWCONFIG_CLASSPATH=%JAVA_HOME%\lib\tools.jar;%BEA_HOME%\utils\config\10.3\config-launch.jar;%WL_HOME%\server\lib\weblogic_sp.jar;%WL_HOME%\server\lib\weblogic.jar;%FEATURES_DIR%\weblogic.server.modules_10.3.5.0.jar;%WL_HOME%\server\lib\webservices.jar;%ANT_HOME%/lib/ant-all.jar;%ANT_CONTRIB%/lib/ant-contrib.jar
