...
set BEA_JAVA_HOME=D:\Oracle\Middleware1035\jrockit_160_24_D1.1.2-4

set SUN_JAVA_HOME=D:\Oracle\Middleware1035\jdk160_24
...
if "%JAVA_VENDOR%"=="Oracle" (
	...
	if "%JAVA_VENDOR%"=="Sun" (
		...
		set JAVA_VENDOR=Sun
		set JAVA_HOME=D:\Oracle\Middleware1035\jdk160_24
	)
)
...
set DOMAIN_HOME=D:\Oracle\Middleware1035\user_projects\domains\base_domain
for %%i in ("%DOMAIN_HOME%") do set DOMAIN_HOME=%%~fsi

set LONG_DOMAIN_HOME=D:\Oracle\Middleware1035\user_projects\domains\base_domain
...
set MEM_PERM_SIZE_64BIT=-XX:PermSize=400m

set MEM_PERM_SIZE_32BIT=-XX:PermSize=400m
...
set MEM_MAX_PERM_SIZE_64BIT=-XX:MaxPermSize=400m

set MEM_MAX_PERM_SIZE_32BIT=-XX:MaxPermSize=400m
