...
public class JDBCAppender extends org.apache.log4j.AppenderSkeleton
   ...
   * */
	protected void execute(String sql) throws SQLException {
		...
		// 需要过滤的打印日志位置
		String[] filteredClasses = new String[] { "persistence",
				"org.hibernate.", "org.springframework.",
				"antelope.db.SqlLoader",
				"org.quartz.core.SchedulerSignalerImpl",
				"org.apache.axis2.deployment.util.Utils",
				"org.quartz.core.QuartzScheduler", "org.apache.axis2.",
...
//	     setDriver("sun.jdbc.odbc.JdbcOdbcDriver");
      ...
      if (connection == null || connection.isClosed()) {
        try {
			connection = DBHelper.getDataSource().getConnection();
		} catch (IOException e) {
			e.printStackTrace();
