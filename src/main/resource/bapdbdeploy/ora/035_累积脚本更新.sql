...
CREATE TABLE WCM_PAGE (
	...
	templatesid varchar2(36) NULL, 
	templatename varchar2(200) NULL, 
...
CREATE TABLE WCM_CONTAINER_DATA (
	sid varchar2(36) NOT NULL, 
	assetsid varchar2(36) NOT NULL, 
	pagesid varchar2(36) NOT NULL, 
	containersid varchar2(36) NULL, 
	PRIMARY KEY (sid)
);
...
alter table WCM_PAGE add pagetype varchar2(1) NULL;




alter table WCM_CONTAINER_DATA add assettype varchar2(1) NULL;



alter table SYS_FILES add filedesc varchar2(4000) NULL;
